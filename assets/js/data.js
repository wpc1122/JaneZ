...
const TIMELINE = [
  ...
  { year: '2008', date: '10.', title: '《画心》全网传唱', desc: '为电影《画皮》演唱主题曲《画心》，移动数字音乐领域下载量达1亿次。' },
  ...
  { year: '2011', date: '11.', title: 'MAMA 亚洲最佳歌手', desc: '获得韩国 Mnet 亚洲音乐大奖（MAMA）亚洲最佳歌手奖；专辑《改变》获IFPI"双倍白金唱片"销量认证。' },
  { year: '2012', date: '06.08', title: '现场专辑《倾听》', desc: '以 24bit/96KHz 发烧级标准现场一次录制成型，第七次蝉联北京流行音乐典礼最佳女歌手。' },
  { year: '2013', date: '02.', title: '首次登上央视春晚', desc: '与杨坤合唱《一辈子朋友》，成为首位登上央视春晚的选秀出身内地歌手。同年演唱《咱们结婚吧》主题曲《终于等到你》。' },
  { year: '2014', date: '07.21', title: '专辑《第七感》', desc: '签约索尼音乐并推出专辑《第七感》，同年担任第38届蒙特利尔国际电影节评委。' },
  { year: '2015', date: '07.', title: '献声好莱坞大片', desc: '与美国说唱歌手 Big Sean 合唱《终结者：创世纪》全球主题曲《Fighting Shadows》；同年作为首发歌手参加《我是歌手第三季》。' },
  { year: '2016', date: '10.', title: '英文单曲闯入美国 iTunes', desc: '全球发行首支英文单曲《Dust My Shoulders Off》，登上美国 iTunes 即时榜第4名。' },
  { year: '2017', date: '11.', title: '首位登上维密秀的亚洲歌手', desc: '受邀担任《2017维多利亚的秘密时尚秀》表演嘉宾，表演曲目登上美国 iTunes 即时榜前十。' },
  ...
  { year: '2023', date: '04.', title: '《天赐的声音》第四季', desc: '参加浙江卫视音乐励志节目并演唱本季主题曲《最初的爱》；同年献唱成都大运会主题曲《爱是一样的》。' },
